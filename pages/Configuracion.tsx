      ...
      <div className={styles.contenedorConfiguracion}>
        ...
        <div className={styles.divContenidoGeneral}>
          ...
          <form className={styles.contenedorCorreo} onSubmit={compararContrasenas}>
            <input type="password" className={styles.inputCorreo} onChange={event => setContrasenaActual(event.target.value)} placeholder='Contraseña actual'/>
            <input type="password" className={styles.inputCorreo} onChange={event => setContrasenaActualRepetida(event.target.value)} placeholder='Repetir contraseña'/>
          ...
          <form className={styles.modal03} style={{display}} onSubmit={cambiarContrasena}>
            ...
            <input type='password' className={styles.modalInput03} onChange={event => setContrasenaNueva(event.target.value)} placeholder='Contraseña actual'/>
